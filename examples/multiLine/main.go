...
func main() {
	...
	contents := []string{
		...
		"[[云健]]“他脑子有病，我又没病。”",
		`[[云健]]“不能和一个有脑疾的纨绔一般见识。”`,
		`以脾气火爆闻名第三初级学院资深教习丁三十，在心中一遍遍地默念，努力让自己无视这个全城最大的纨绔败家子，继续上课。`,
		`其他学员看到‘暴躁教习’丁三十如此‘忍气吞声’的样子，不由得都忍俊不禁，想笑也不敢笑出声。`,
...
var displayShortMap = map[string]string{
	...
	"晓贝": "zh-CN-liaoning-XiaobeiNeural",
...
func splitSpeaker(content string) (string, string) {
	...
	if startIndex == -1 || endIndex == -1 {
		return "zh-TW-YunJheNeural", content
	}
